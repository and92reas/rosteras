<%@ Page Title="" Language="C#" MasterPageFile="~/Nested1.Master" AutoEventWireup="true" CodeBehind="CompareTeams.aspx.cs" Inherits="Rosteras.CompareTeams" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    <asp:Panel ID="Panel45" CssClass = 'selPanel5' runat="server">
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" CssClass = "selpanel1" runat="server" Width="325px">
        <asp:Label ID="Selection" runat="server" CssClass = "Selection1" Text="<h3> Eπιλογή 1ης Ομάδας </h3>"></asp:Label>
        <asp:Label ID="LeagueSelection" runat="server" CssClass = "TeamSelection1" Text="<h6> Πρωτάθλημα1 </h6>"></asp:Label>
        <asp:DropDownList ID="ddlLeagues" runat="server" DataSourceID="Roster5" CssClass = "ddlTeams" 
        DataTextField="Ονομασία" DataValueField="Ονομασία" AutoPostBack = "True" >
        </asp:DropDownList>
        <asp:SqlDataSource ID="Roster5" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ΡόστερConnectionString %>" 
            
            SelectCommand="SELECT [Ονομασία] FROM [Πρωταθλήματα] WHERE ([Τάξη] IS NOT NULL) ORDER BY [Τάξη]">
        </asp:SqlDataSource>
        <asp:Label ID="TeamSelection1" runat="server" CssClass = "PlayerSelection" Text="<h6> Ομάδα1 </h6>"></asp:Label>
        <asp:DropDownList ID="ddlTeams" runat="server" DataSourceID="Roster7" CssClass = "ddlPlayers" 
        DataTextField="Ονομασία" DataValueField="Ονομασία">
    </asp:DropDownList>
        <asp:SqlDataSource ID="Roster7" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ΡόστερConnectionString %>" 
            SelectCommand="SELECT [Ονομασία] FROM [Ομάδες] WHERE ([Πρωτάθλημα] = @Πρωτάθλημα)">
            <SelectParameters>
                <asp:ControlParameter ControlID="ddlLeagues" Name="Πρωτάθλημα" 
    ...
    <asp:Panel ID="Panel2" CssClass = "selpanel2" runat="server" Width="325px">
        <asp:Label ID="Selection2" runat="server" CssClass="Selection2" Text="<h3> Eπιλογή 2ης Ομάδας </h3>"></asp:Label>
        <asp:Label ID="LeagueSelection2" runat="server" CssClass = "TeamSelection2" Text="<h6> Πρωτάθλημα2 </h6>"> 

</asp:Label>
        <asp:DropDownList ID="ddlLeagues2" runat="server" DataSourceID="Roster6" CssClass = "ddlTeams2"
        DataTextField="Ονομασία" DataValueField="Ονομασία" AutoPostBack = "True"
         >
        </asp:DropDownList>
        <asp:SqlDataSource ID="Roster6" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ΡόστερConnectionString %>" 
            
            
            SelectCommand="SELECT [Ονομασία] FROM [Πρωταθλήματα] WHERE ([Τάξη] IS NOT NULL) ORDER BY [Τάξη]">
        </asp:SqlDataSource>
        <asp:Label ID="PlayerSelection2" runat="server" CssClass = "PlayerSelection2" Text="<h6> Ομάδα2 </h6>"></asp:Label>
        <asp:DropDownList ID="ddlTeams2" runat="server" DataSourceID="Roster8" CssClass = "ddlPlayers2"
        DataTextField="Ονομασία" DataValueField="Ονομασία" AutoPostBack ="True" 
        >
        </asp:DropDownList>
        <asp:SqlDataSource ID="Roster8" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ΡόστερConnectionString %>" 
            SelectCommand="SELECT [Ονομασία] FROM [Ομάδες] WHERE ([Πρωτάθλημα] = @Πρωτάθλημα)">
            <SelectParameters>
                <asp:ControlParameter ControlID="ddlLeagues2" Name="Πρωτάθλημα" 
                    PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
     </asp:Panel>
